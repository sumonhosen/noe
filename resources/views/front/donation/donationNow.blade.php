                    ...
                    <div id="amount_div" class="text-center">
                        <form action="{{route('donation.payment')}}" type="POST">
                            ...
                            <div class="form-group row mt-5">
                                <div class="col-sm-6">
                                    <button type="button" id="payment_one" onclick="payment_method(1)" class="btn btn-danger btn-lg btn-block">Give Monthly</button>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div id="payment_div">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="f_payment" id="f_payment_tt" required>
                                            <option value="null" selected>Select Payment</option>
    ...
    <script>
        function payment_method(val){
            if(val==1){
                ...
                $('#f_payment_tt').val(null);
                $('#payment_two').addClass('btn-danger');
                $('#payment_two').removeClass('btn-outline-primary');

                $('#payment_one').addClass('btn-outline-primary');
                $('#payment_one').removeClass('btn-danger');
            }
        }
