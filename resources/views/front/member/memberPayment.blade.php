            ...
            <div class="col-md-5">
                <div class="card mt-5 shadow mb-4">
                    <div class="card-header">
                        <h5>Member Payment</h5>
                    </div>

                    <div class="card-body">
                        <p>Payment Amount: <b>{{($settings_g['currency_symbol'] ?? '$') . $user->amount }}</b></p>

                        <form role="form" action="{{route('member.payment.store')}}" method="post" class="stripe-payment"
